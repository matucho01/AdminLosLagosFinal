...
/**
 * Esta clase define los métodos para registrar y proyectar las ventas en galones
 * @author Equipo de desarrollo Scrum
 * @version 08/03/2023/A
 */
public class Registro {
    ...
    /**
     * Método para tokenizar o dar formato al String recibido
     * @param fecha String en formato "yyyy-MM-dd" 
     * @return Una lista con 3 elementos, cada uno es un componente de la fecha
     */
    ...
    /**
     * Método para obtener los galones en el formato: 1500 galones -> 1.5
     * @param galones Valor de los galones en tipo flotante
     * @return El valor formateado del parámetro ingresado 
     */
    ...
    /**
     * Método para encontrar la posición de una fecha
     * @param fecha String en formato "yyyy-MM-dd" 
     * @param turnos Lista de turnos
     * @return La posición de una fecha
     */
    ...
    /**
     * Método para imprimir los valores mayores de cada tipo de producto
     * @param mayorDemanda Un ArrayList que contiene los valores de cada producto
     */
    ...
    /**
     * Método para obtener el valor máximo de cada ArrayList con cada producto
     * @return Un ArrayList con los 3 valores que representan el valor más alto
    ...
    /**
     * Método para totalizar los consumos semanales por producto
     * @param fecha Un String en formato "yyyy-MM-dd"
     * @param turnos Un ArrayList de turnos
     */
    public void totalizarConsumosSemanales(String fecha, ArrayList<Turno> turnos) {
        ...
        for (int i = 1; i < 4; ++i) {
            c.set((Integer) elementosFecha.get(2), (Integer) elementosFecha.get(1),
                    (Integer) elementosFecha.get(0));
            c.add(5, -7 * i);
    ...
    /**
     * Método para realizar la proyección de las ventas en galones
     * @param fecha Un String en formato "yyyy-MM-dd"
     * @param turnos Un ArrayList de turnos
     * @param galonesSuper Un valor correspondiente al inventario actual
     * @param galonesExtra Un valor correspondiente al inventario actual
     * @param galonesDiesel Un valor correspondiente al inventario actual
     * @return Un ArrayList con 3 valores correspondientes al pedido
     */
    public ArrayList<Float> proyectarVentas(String fecha, ArrayList<Turno> turnos, 
            float galonesSuper, float galonesExtra, float galonesDiesel) {
        float total = 0.0F;
        ...
        while (total <= 10) {
            ...
            estimadorSuper = (float) Math.round((Float) this.obtenerMayor().get(0) 
                    - this.formatearGalones(galonesSuper));
            estimadorExtra = (float) Math.round((Float) this.obtenerMayor().get(1) 
                    - this.formatearGalones(galonesExtra));
            estimadorDiesel = (float) Math.round((Float) this.obtenerMayor().get(2) 
                    - this.formatearGalones(galonesDiesel));
